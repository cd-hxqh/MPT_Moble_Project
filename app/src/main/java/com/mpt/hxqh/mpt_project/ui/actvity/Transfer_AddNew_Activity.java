    ...
    private void startAsyncTask() {
        new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... strings) {
                String reviseresult = AndroidClientService.AddAssetTrs(Transfer_AddNew_Activity.this, descriptionTextView.getText().toString(),
            ...
            protected void onPostExecute(String workResult) {
                ...
                if (workResult == null) {
                    ...
                    Toast.makeText(Transfer_AddNew_Activity.this, workResult, Toast.LENGTH_SHORT).show();
//                    setResult(100);
                    finish();
                }
                closeProgressDialog();
