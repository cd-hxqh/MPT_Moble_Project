...
//        submit.setVisibility(View.VISIBLE);
        ...
        public void onClick(View v) {
            ...
            dialog.setOnBtnClickL(
                    ...
                    new OnBtnClickL() {
                        @Override
                        public void onBtnClick() {
                            AppManager.AppExit(PO_AddNew_Activity.this);
                        }
                    });
    ...
    private View.OnClickListener optionOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            final NormalListDialog normalListDialog = new NormalListDialog(PO_AddNew_Activity.this, optionList);
    ...
    private void startAsyncTask() {
        new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... strings) {
                String reviseresult = AndroidClientService.AddPo(PO_AddNew_Activity.this, descriptionTextView.getText().toString(),
            ...
            protected void onPostExecute(String workResult) {
                ...
                if (workResult == null) {
                    ...
                    Toast.makeText(PO_AddNew_Activity.this, workResult, Toast.LENGTH_SHORT).show();
//                    setResult(100);
                    finish();
                }
                closeProgressDialog();
