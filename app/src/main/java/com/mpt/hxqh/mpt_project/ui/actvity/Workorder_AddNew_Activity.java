 ...
 * 物料出库新增
 **/
public class Workorder_AddNew_Activity extends BaseActivity {

    private static final String TAG = "Workorder_AddNew_Activity";
...
//        submit.setVisibility(View.VISIBLE);
    ...
    private View.OnClickListener quitOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            final NormalDialog dialog = new NormalDialog(Workorder_AddNew_Activity.this);
            ...
            dialog.setOnBtnClickL(
                    ...
                    new OnBtnClickL() {
                        @Override
                        public void onBtnClick() {
                            AppManager.AppExit(Workorder_AddNew_Activity.this);
                        }
                    });
    ...
    private View.OnClickListener optionOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            final NormalListDialog normalListDialog = new NormalListDialog(Workorder_AddNew_Activity.this, optionList);
...
//                    normalListDialog.dismiss();
    ...
    private View.OnClickListener locationTextViewOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(Workorder_AddNew_Activity.this, LocationChooseActivity.class);
